		...
		<div className="pt-5">
			...
			<section className="pb-24 pt-20">
				<div className="w-full flex px-12 sm:px-20 md:pl-60 justify-between gap-16 h-auto pt-10 font-poppins">
					...
					<div className="bg-opacity-50 sm:text-xl w-full rounded-2xl grid md:grid-cols-2 text-black">
						<div>
						...
						<div className="pt-5">
							...
							<p className="pt-5">
								Nam nec ante. Sed lacinia, urna non tincidunt
								mattis, tortor neque adipiscing diam, a cursus
								ipsum ante quis turpis.
							</p>
						</div>
						<div className="pt-5">
							<FaCarRear className="text-4xl mb-4 text-blue-400" />
							<h1 className="text-2xl font-bold md:text-4xl">
								Expert Car Service
							</h1>
							<p className="pt-5">
