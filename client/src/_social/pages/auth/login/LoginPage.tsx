...
const LoginPage: React.FC = () => {
    ...
    // send verification mail to reset password 
    const {mutate: sendResetToken, isPending: isSendingResetToken} = useMutation({
        mutationFn: async (email: string) => {
            try {
                                        ...
                                        >
                                                {["Gmail"].map((placeholder, index) => (
                                                    ...
                                                    >
                                                        ...
                                                        />
                                                            <label
                                                                className={
                                                                        `absolute -left-16 top-6 text-gray-400 text-base peer-focus:-top-3 
                                                                        peer-focus:left-0 peer-focus:text-sm transition-all duration-300 ml-12 ${
                                                                        signUpData[placeholder as keyof typeof signUpData]
                                                                        ? "-top-3 text-sm"
                                                                        : "" }`
                                                                }
                                                            >
                                                ...
                                                <div className="pt-12 relative flex justify-center">
                                                    <Button
                                                        ...
                                                        onClick={() => {
                                                            toggleForm("number")
                                                            // sendResetToken(emaildata.email)
                                                        }}>
                                                        <div>
                                                        C
                                                        <span className="lowercase">
