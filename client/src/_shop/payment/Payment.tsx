			...
			<div className="container mx-auto p-6 md:p-10 bg-gray-800 bg-opacity-90 backdrop-blur-md rounded-3xl">
				...
				<div className="mt-4 grid grid-cols-1 gap-4 md:gap-6">
					<input
						type="text"
						name="number"
						className="form-control bg-gray-950 border border-gray-300 p-3 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:shadow-blue-400 focus:shadow-md transition-all duration-300  text-gray-800"
					...
					<div className="grid grid-cols-2 gap-4 ">
						...
						<select
							data-aos="fade-left"
							data-aos-delay="500"
							className=" select col-span-2 form-control bg-gray-950 text-white border border-gray-300 p-3 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:shadow-blue-400 focus:shadow-md transition-all duration-300"
						>
