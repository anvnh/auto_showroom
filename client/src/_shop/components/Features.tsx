		...
		<div className="pt-5">
			...
			<section className="pb-24 pt-20">
				<div className="w-full flex px-12 sm:px-20 md:pl-60 justify-between gap-16 h-auto pt-10 font-poppins">
					<div data-aos="fade-up" className="bg-opacity-50 rounded-2xl flex items-start justify-start text-black ">
						<div data-aos="fade-down"className="md:text-5xl text-2xl sm:text-4xl font-bold mt-10">
							We're BIG on <br /> what matters to you
						</div>
					</div>
					<div data-aos="fade-right"  className="bg-opacity-5 sm:text-xl w-full grid md:grid-cols-2 text-black bg-gray-600 p-10 rounded-3xl hover:bg-opacity-20  duration-500 ease-in-out transition-all">
						<div className="space-y-2">
							<GoShieldCheck className="text-4xl text-blue-400" />
							<h1 data-aos="fade-left" className="text-2xl sm:text-3xl md:text-4xl font-bold">
								Special Financing Offers
							</h1>
							<p data-aos="fade-right" data-aos-delay="400" className="pt-5">
						...
						<div className="space-y-2">
							...
							<h1 data-aos="fade-left" className="text-2xl font-bold md:text-4xl">
