    ...
    <div className="">
      ...
      <div>
        ...
        <section className="relative h-screen w-screen flex justify-center items-center">
          ...
          <img src={car417} className="absolute w-[150px] h-[70px] right-[5%] bottom-[5%] hidden mlg:block z-10" />
          <img src={car418} className="absolute w-[150px] h-[70px] left-[5%] bottom-[5%] hidden mlg:block z-10" />
        </section>
        ...
        <section className="relative h-screen w-screen flex justify-center items-center">
          <div
            ref={hero_section3}
            style={{ backgroundImage: `url(${car41})` }} className="bg  absolute top-0 left-0 w-screen h-screen z-10 object-cover 
