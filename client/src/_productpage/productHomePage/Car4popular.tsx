    ...
    <div className={`${isPopupVisible ? "overflow-y-hidden" : "overflow-y-visible"} `}>
      ...
      <div>
        ...
        <section className="relative h-screen w-screen flex justify-center items-center">
          ...
          "></div>
          <h1 className="text-center text-[60px] xs:text-[105px] sm:text-[140px] md:text-[150px] lg:text-[190px] mlg:text-[225px] xl:text-[170px] font-kanit  w-full z-10 text-slate-50 font-bold text-7xl ">AUDI R8 COUPE 2022 </h1>s
          <p className="absolute pt-12 font-syncopate md:text-[40px] lg:text-[50px] text-white top-[10%] left-[5%] hidden md:block">
            2024
          </p>
          <p className="absolute font-syncopate pt-12 md:text-[40px] lg:text-[50px] text-white top-[10%] right-[5%] hidden md:block">
            VIETNAM
          </p>
        ...
        <section className="relative h-screen w-screen flex justify-center items-center">
          <div
            ref={hero_section3}
            style={{ backgroundImage: `url(${car41})` }} className="bg  absolute top-0 left-0 w-screen h-screen z-1 object-cover 
          bg-center bg-no-repeat   flex justify-center items-center gap-x-[6%]">
            <p
              ref={sec3_img1}
              className="w-[25%] h-[70%]  ">
              <img src={car42} className="w-full h-full object-cover " />
            </p>
            <p
              ref={sec3_img2}
              className="w-[25%] h-[70%] ">
              <img src={car46} className="w-full h-full object-cover" />
            </p>
        ...
        <div
			...
			>
              ...
              before:ease relative h-10 md:h-12 md:w-36 overflow-hidden  shadow-xl before:absolute before:right-0 before:top-0 before:h-12 before:w-6 before:translate-x-12 before:rotate-12 before:bg-gray-500 before:opacity-80 before:duration-700 hover:shadow-white hover:before:-translate-x-[200px]"
				...
				>
					<source src={changecolor4} type="video/mp4" />
				</video>
				<div
					onClick={() => {
						showPopup();
        ...
        <div ref={container_hero} className="hero  relative w-screen h-screen">
          ...
          <div
            ref={hero_txt}
            className="z-1 absolute top-[5%]  left-0  text-slate-200 mx-[20px] my-[20px] sm:my-[80px] sm:mx-[50px]"
          >
    ...
    <div
        ...
        <div ref={container_split1} className="relative hidden  lg:flex  w-screen h-screen">
          <div className="h-full w-full flex flex-col justify-center items-center lg:w-[50%] bg-slate-900 ">
            <img ref={split1_img} src={car417} className="opacity-0 lg:h-[400px] lg:w-[500px] mlg:h-screen mlg:w-screen object-cover" />
        ...
        <div ref={container_split2} className="relative hidden lg:flex  w-screen h-screen text-slate-800">
          ...
          <div className="h-screen w-[50%] flex justify-center items-center bg-slate-900">
            <img ref={split2_img} src={car419} className="opacity-0 lg:h-[400px] lg:w-[500px] mlg:h-screen mlg:w-screen  object-cover" />
          </div>
        </div>
        {/* ------------------------mobile--------- */}
        <div className=" w-full h-full flex flex-col lg:hidden">
          <div className="w-screen h-[600px]">
            <img src={car49} className="w-screen h-full object-cover" />
          </div>
        ...
        <div className="w-screen h-full flex lg:hidden flex-col ">
          <div className="w-screen h-[600px]">
            <img src={car410} className="w-full h-full object-cover" />
          </div>
          <div className="w-screen flex flex-col justify-center items-center h-[300px]  bg-slate-100 text-slate-800 ">
            <h1
        ...
        <section className="relative h-screen w-screen flex justify-center items-center">
          ...
          bg-center bg-no-repeat  bg-cover 
          "></div>
          <h1 className="text-center  text-[70px] md:text-[150px] mlg:text-[190px] font-kanit  w-full z-10 text-white   ">SPORTS </h1>
        </section>
        <section className="relative h-screen w-screen flex justify-center items-center"  >
          <div
            style={{ backgroundImage: `url(${car412})` }}
            className="bg  absolute top-0 left-0 w-screen h-screen z-10 object-cover
          bg-center bg-no-repeat  bg-cover"></div>
          <h1 className="text-center text-[70px] md:text-[150px] mlg:text-[190px] 
            font-kanit   w-full z-10  text-white">MODERN</h1>
        </section>
        <section className="relative h-screen w-screen flex justify-center items-center">
          <div style={{ backgroundImage: `url(${car415})` }} className="bg  absolute top-0 left-0 w-screen h-screen z-10 object-cover
          bg-center bg-no-repeat  bg-cover"></div>
          <h1 className="text-center text-[70px] md:text-[150px] mlg:text-[190px] font-kanit   w-full z-10 text-white">LUXURY</h1>
        </section>
        <section className="relative h-screen w-screen flex justify-center items-center">
          <div style={{ backgroundImage: `url(${car414})` }} className="bg  absolute top-0 left-0 w-screen h-screen z-10 object-cover
          bg-center bg-no-repeat  bg-cover"></div>
        ...
        >
          ...
          <div className="w-full md:w-[60%] h-[65%] md:h-full relative">
            <img ref={sec1_img1} src={car47} className="opacity-0 absolute top-0 md:top-[15%] lg:top-[20%] mlg:top-[14%] left-[50px] w-[450px] md:w-[500px] mlg:w-[550px]   xl:w-[800px] h-[300px] md:h-[300px] lg:h-[320px] mlg:h-[370px] object-cover" />
            <img ref={sec1_img2} src={car48} className="opacity-0 absolute bottom-[12%]  md:bottom-[25%] lg:bottom-[15%] mlg:bottom-[10%] right-[50px] w-[450px] md:w-[500px] mlg:w-[550px]  xl:w-[800px] h-[300px] md:h-[300px] lg:h-[320px] mlg:h-[370px] object-cover" />
          </div>
        </div>
        {/* medium -> */}
        <div
          ...
          <div className="w-[60%] h-full relative">
            <img ref={sec2_img1} src={car4BH} className=" absolute top-[20%] md:top-[15%] lg:top-[20%] mlg:top-[14%] left-[50px] w-[350px] md:w-[500px] mlg:w-[550px]   xl:w-[800px] h-[250px] md:h-[300px] lg:h-[320px] mlg:h-[370px] object-cover" />
            <img ref={sec2_img2} src={car4BH2} className=" absolute bottom-[25%]  md:bottom-[25%] lg:bottom-[15%] mlg:bottom-[10%] right-[50px] w-[350px] md:w-[500px] mlg:w-[550px]  xl:w-[800px] h-[250px] md:h-[300px] lg:h-[320px] mlg:h-[370px] object-cover" />
          </div>
        ...
        >
          ...
          <div className="w-full md:w-[60%] h-[65%] md:h-full relative">
            <img ref={sec2_img11} src={car46} className="opacity-0 absolute top-0 md:top-[15%] lg:top-[14%] left-[50px] w-[450px] md:w-[500px] mlg:w-[550px]   xl:w-[800px] h-[300px] md:h-[300px] lg:h-[320px] mlg:h-[370px] object-cover" />
            <img ref={sec2_img22} src={car47} className="opacity-0 absolute bottom-[12%]  md:bottom-[25%] lg:bottom-[10%] right-[50px] w-[450px] md:w-[500px] mlg:w-[550px]  xl:w-[800px] h-[300px] md:h-[300px] lg:h-[320px] mlg:h-[370px] object-cover" />
          </div>
        </div>
        ...
        <div className="w-full h-screen flex sm:hidden flex-col bg-slate-100 text-slate-800 " >
          ...
          <div className="w-full h-full relative bg-slate-500">
            <img src={car41} className="absolute  w-[350px]  h-[250px] left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%]  object-cover" />
        ...
        >
          ...
          <div className="w-full  h-full relative bg-green-800">
            <img src={car42} className="absolute w-[350px]  h-[250px]  object-cover left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%]" />
        ...
        >
          <div ref={box_left} className="w-[40%]  h-screen  ">
            <div className="h-full w-full flex flex-col justify-center items-center border-r border-r-slate-800 ">
              ...
              <p className="w-full h-[70px]  text-center text-[50px] md:text-[70px]    font-kanit font-bold ">
                  Audi R8 Coupe <br />
                  <div className="h-[40px]  text-center text-[20px]  md:text-[40px] font-kanit font-light"> $ 208 100</div>
                </p></Link>
          ...
          <div ref={box_right} className="h-[400%] w-[60%] pb-20 flex flex-col text-slate-800">
            ...
            >
              <img ref={section3_img} src={car413} className="w-[80%] object-cover"></img>
            </div>
            ...
            >
              <img src={car45} className="w-[80%] h-[80%] object-cover" />
            </div>
            <div
              ref={right_section6}
              className="w-full h-[400px] md:h-[600px] flex justify-center items-center"
            ...
            <div
              ...
              className="w-full h-[400px]  md:h-[600px] flex justify-center items-center"
            >
              <img src={car49} className="w-[80%] h-[80%" />
            </div>
          </div>
        </div>
        ...
        <div className=" flex md:hidden justify-center items-center w-screen h-screen gap-x-[5%]    ">
          <img src={car45} className="object-cover w-[170px] xs:w-[200px] sm:w-[270px] h-[60%] xs:h-[70%]" />
        ...
        <div className="w-screen h-screen flex md:hidden flex-col justify-center items-center bg-slate-900">
          ...
          <img src={car46} className="w-[75%] h-[40%] xs:w-[70%] xs:h-[50%] object-cover" />
        </div>
        ...
        <div className="w-screen h-screen flex md:hidden flex-col justify-center items-center">
          ...
          <img src={car46} className="w-[75%] pt-12 h-[40%] xs:w-[70%] xs:h-[50%] object-cover" />
        </div>
