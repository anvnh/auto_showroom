...
const NavbarSmall: React.FC<SubNavbarProps> = ({
	...
	const navItems = [
		...
		{ id: "Member_Benefit", label: "Member Benefit" },
		{ id: "commitment", label: "AAP commitment" },
		...
		<div className="hidden md:block">
			...
			>
				{isVisible && (
					...
					>
						<div className="px-3 py-6 rounded-tl-xl rounded-bl-xl backdrop-blur-2xl bg-gray-900 bg-opacity-75 text-white duration-600 transition-all ease-in-out">
						...
						{isHovered && (
							<div className="bg-gray-800 bg-opacity-75 backdrop-blur-2xl text-white pl-1 pr-3 py-4 rounded-tr-3xl rounded-br-3xl ml-0 transition-all duration-1000 transform origin-left scale-y-0 group-hover:scale-y-100">
