...
function ChatAI() {
  ...
  useEffect(() => {
    if (isChatBoxVisible && !hasSentAutoMessage) {
      setMessages((prev) => [...prev, { type: "answer", text: "Hi, what car models do you want me to advise you on? Ask any questions and I will answer your questions." }]);
      setHasSentAutoMessage(true);
    }
  }, [isChatBoxVisible, hasSentAutoMessage]);
        ...
        <>
          {!isChatBoxVisible && (
            ...
            >
              ...
              {showAutoMessage && (
                <div  className="absolute w-[240px] font-poppins right-full mr-4 bottom-1/2 transform translate-y-1/2 px-3 py-2 bg-white text-black text-sm rounded-xl">
          ...
          {isChatBoxVisible && (
            <div data-aos="fade-left" className="w-[350px] shadow-white bg-gray-900 rounded-lg shadow-sm text-white overflow-hidden">
                    ...
                    {messages.map((msg, index) => (
                      <div key={index} className="flex w-full">
                        {msg.type === "question" ? (
                          ...
                          <div className="mr-auto max-w-[75%] my-2 p-2 rounded-lg bg-gray-500 self-start text-left whitespace-pre-line">
                            {msg.text}
