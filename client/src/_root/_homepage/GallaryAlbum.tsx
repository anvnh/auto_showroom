  ...
  return (
    <div ref={con_col} className="overflow-y-hidden
       w-screen h-screen flex justify-evenly items-center ">
        <section ref={col1} className="object-cover w-[20%] h-[400%]  flex flex-col justify-evenly items-center ">
        ...
        <section ref={col2} className="w-[20%] h-[400%]  flex flex-col justify-evenly items-center">
          <img src={a1} className="w-full h-[500px] object-cover" />
          <img src={a2} className="w-full h-[500px] object-cover" />
          <img src={a3} className="w-full h-[500px] object-cover" />
          <img src={a1} className="w-full h-[500px] object-cover" />
        ...
        <section ref={col3} className="w-[20%] h-[400%]  flex flex-col justify-evenly items-center">
          <img src={a2} className="w-full h-[500px] object-cover" />
          <img src={a3} className="w-full h-[500px] object-cover" />
          <img src={a1} className="w-full h-[500px] object-cover" />
          <img src={a2} className="w-full h-[500px] object-cover" />
        ...
        <section ref={col4} className="w-[20%] h-[400%]  flex flex-col justify-evenly items-center">
          <img src={a1} className="w-full h-[500px] object-cover" />
          <img src={a3} className="w-full h-[500px] object-cover" />
          <img src={a2} className="w-full h-[500px] object-cover" />
          <img src={a3} className="w-full h-[500px] object-cover" />
