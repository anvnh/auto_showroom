            ...
            <section className="w-screen h-[400%] relative">
                <div ref={section1} className=" w-screen h-screen flex flex-col justify-between items-center  sticky top-0  ">
                    ...
                    <div className="mt-[10%] overflow-y-hidden  w-full  h-[20%]  backdrop-blur-[5px] ">
                        <p ref={section1_txt1} className=" text-[120px] w-full text-center font-bold font-kanit">TOYOTA</p>
                    </div>
                    <div className="overflow-y-hidden z-50 w-full  h-[20%] flex justify-center">
                        <p ref={section1_txt2} className="text-[20px] w-[80%] text-center font-bold font-kanit">Toyota's origins lie in the Japanese weaving industry when Sakichi Toyoda invented the world's first automatic loom and, subsequently</p>
                    </div>
                ...
                <div ref={section2} className=" w-screen h-screen flex flex-col justify-between items-center sticky top-0  ">
                    ...
                    <div className="mt-[10%] overflow-y-hidden  w-full  h-[20%]  backdrop-blur-[5px] ">
                        <p ref={section2_txt1} className=" text-[120px] w-full text-center font-bold font-kanit">Honda</p>
                    </div>
                    <div className="overflow-y-hidden z-50 w-full  h-[20%] flex justify-center">
                        <p ref={section2_txt2} className="text-[20px] w-[80%] text-center font-bold font-kanit">The guiding ideals that still shape Honda to this day are formed. The company principle is enshrined: “Maintaining a global viewpoint, we are dedicated to supplying products of the highest quality yet at a reasonable price for worldwide customer satisfaction.”
</p>
                    </div>
                    <div className="w-full z-0 absolute top-0 h-full bg-stone-800 mix-blend-color  flex justify-center items-center ">
                    </div>
                ...
                <div ref={section3} className=" w-screen h-screen flex flex-col justify-between items-center sticky top-0  ">
                    ...
                    <div className="mt-[10%] overflow-y-hidden  w-full  h-[20%]  backdrop-blur-[5px] ">
                        <p ref={section3_txt1} className=" text-[120px] w-full text-center font-bold font-kanit">Mercedes</p>
                    </div>
                    <div className="overflow-y-hidden z-50 w-full  h-[20%] flex justify-center">
                        <p ref={section3_txt2} className="text-[20px] w-[80%] text-center font-bold font-kanit">The age of the motorized motor coach dawns on 18 March 1895. The world’s first motor coach, ordered on 19 December 1894 from Benz & Co. in Mannheim, begins a scheduled bus service on the route Siegen–Netphen–Deuz</p>
                    </div>
                    <div className="w-full z-0 absolute top-0 h-full bg-stone-800 mix-blend-color  flex justify-center items-center ">
                    </div>
                </div>
                ...
                <div ref={section4} className=" w-screen h-screen flex flex-col justify-between items-center sticky top-0  ">
                    ...
                    <div className="mt-[10%] overflow-y-hidden  w-full  h-[20%]  backdrop-blur-[5px] ">
                        <p ref={section4_txt1} className=" text-[120px] w-full text-center font-bold font-kanit">Audi</p>
                    </div>
                    <div className="overflow-y-hidden z-50 w-full  h-[20%] flex justify-center">
                        <p ref={section4_txt2} className="text-[20px] w-[80%] text-center font-bold font-kanit">The history of AUDI AG extends back to the 19th century. Find out more about the great personalities from the company’s 100-plus years of history. Learn about the fascinating evolution of the various models and major milestones in the fields of car manufacturing, motorcycle, engine production and motor racing.</p>
                    </div>
                    <div className="w-full z-0 absolute top-0 h-full bg-stone-800 mix-blend-color  flex justify-center items-center ">
                    </div>
                </div>
