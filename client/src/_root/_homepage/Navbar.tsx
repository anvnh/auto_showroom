...
const Navbar = () => {
	...
	return (
		<div className={`z-50 fixed top-0 w-full bg-gray-800 font-poppins transition-transform duration-300 ${isHidden ? '-translate-y-full' : 'translate-y-0'}`}>
			...
			{section === "vehiclesBar" ? <div className={`z-50 absolute top-[81px] w-screen h-[600px] rounded-b-[20px] font-syncopate  px-[10px] lg:px-[50px] pt-[20px] bg-gray-600`}>
				<div className='rounded-[40px] border-t-[2px] border-slate-400px-[10px] pt-[10px]'>
					<img className="w-[60px]  lg:w-[100px]  " src={kia} />
				</div>
				<div className='flex justify-evenly tex w-screen h-[150px] xs:h-[210px]'>
					<div className="cursor-pointer">
						<div>
							<img className=' sm:w-[190px] lg:w-[250px] hover:scale-110 transition ' src={kiaSoul} />
						</div>
						<p className=' sm:text-[25px] lg:text-[28px]'>Soul</p>
						<p className=' text-[18px]'>$20,190</p>
					</div>
					<div className="cursor-pointer">
						<div>
							<img className=' sm:w-[190px] lg:w-[250px]  hover:scale-110 transition' src={kiaSeltos} />
						</div>
						<p className='xs:text-[25px] md:text-[28px]'>Seltos</p>
						<p className='text-[18px]'>$20,190</p>
					</div>
					<div className="cursor-pointer">
						<div>
						...
						<p className=' xs:text-[25px] lg:text-[28px]'>Soul</p>
						<p className='text-[18px]'>$20,190</p>
					</div>
					<div className="cursor-pointer">
						<div>
				...
				<div className="cursor-pointer">
					...
					<div className="cursor-pointer">
						...
						<p className='xs:text-[25px] lg:text-[28px]'>Etron</p>
						<p className='text-[18px]'>$20,190</p>
					</div>
					<div className="cursor-pointer">
						<div>
						...
						<p className='xs:text-[25px] lg:text-[28px]'>Q5</p>
						<p className='text-[18px]'>$20,190</p>
					</div>
				</div>
				{/* <div  className='rounded-[40px] border-t-[2px] border-slate-400 px-[10px] pt-[10px]'>
